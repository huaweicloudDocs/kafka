# 构造请求<a name="kafka-api-0036212542"></a>
...
## 请求URI<a name="zh-cn_topic_0172572642_zh-cn_topic_0091607286_section1849899574"></a>
...
-   **Endpoint**：
    ...
    指定承载REST服务端点的服务器域名或IP，不同服务不同区域的Endpoint不同，您可以[地区和终端节点](https://developer.huaweicloud.com/endpoint)获取。
...
**图 1**  URI示意图<a name="zh-cn_topic_0172572642_zh-cn_topic_0091607286_fig949762553218"></a>  
...
## 请求方法<a name="zh-cn_topic_0172572642_zh-cn_topic_0091607286_section580035055419"></a>
...
## 请求消息头<a name="zh-cn_topic_0172572642_zh-cn_topic_0091607286_section1454211155819"></a>
...
-   **X-Auth-Token**：用户Token，可选，当使用Token方式认证时，必须填充该字段。用户Token也就是调用[获取用户Token](https://support.huaweicloud.com/api-iam/iam_30_0001.html)接口的响应值，该接口是唯一不需要认证的接口。
    ...
    >![](public_sys-resources/icon-note.gif) **说明：** 
    >DMS API同时支持使用AK/SK认证，AK/SK认证是使用SDK对请求进行签名，签名过程会自动往请求中添加Authorization（签名认证信息）和X-Sdk-Date（请求发送的时间）请求头。
    >AK/SK认证的详细说明请参见[AK/SK认证](认证鉴权.md#zh-cn_topic_0172572644_zh-cn_topic_0091607401_section5887143815518)。
...
## 请求消息体<a name="zh-cn_topic_0172572642_zh-cn_topic_0091607286_section14612192315587"></a>
