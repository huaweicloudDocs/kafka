...
GET  /v1.0/\{project\_jd\}/instances/\{instance\_id\}/manage/topics/\{topic\}
...
<tbody><tr id="row10167112219592"><td class="cellrowborder" valign="top" width="19.388061193880613%" headers="mcps1.2.5.1.1 "><p id="p1116792217595"><a name="p1116792217595"></a><a name="p1116792217595"></a>project_jd</p>
</td>
...
查询成功的状态码[表5](#table1494228595)所示，其他响应见表1-4。
