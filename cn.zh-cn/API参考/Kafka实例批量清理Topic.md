# Kafka实例批量清理Topic<a name="BatchCleanupInstanceTopic"></a>

## 功能介绍

该接口用于向Kafka实例批量清理Topic。

## 调试

您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Kafka&api=BatchCleanupInstanceTopic)中调试该接口。

## URI

POST /v2/kafka/\{project\_id\}/instances/\{instance\_id\}/topics/cleanup
...
<a name="request_BatchCleanupInstanceTopicReq"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.2"><p>是否必选</p>
</th>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>待清理的topic列表。</p>
</td>
</tr>
</tbody>
</table>
...
<a name="response_BatchCleanupInstanceTopicResp"></a>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>是否清理成功</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>清理成功。</p>
</td>
</tr>
</tbody>
</table>
