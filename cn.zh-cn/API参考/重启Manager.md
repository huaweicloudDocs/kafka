# 重启Manager<a name="RestartManager"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=Kafka&api=RestartManager)中调试该接口。

## URI

PUT /v2/\{project\_id\}/instances/\{instance\_id\}/restart-kafka-manager
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>重启Manager成功。</p>
</td>
</tr>
</tbody>
</table>
